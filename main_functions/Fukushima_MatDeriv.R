#' Core function for differentiation
#'
#' @param expr an expression or a string containing a scalar function of X_
#' @param X_ the differentiating variable
#' @param trace_chain = TRUE if to print the history of the rules applied
#' @param debug = 1 to print intermediate results
#'
#' @details
#' Currently, \code{tr} and \code{det} are the only functions
